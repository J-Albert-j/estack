...
public class ExpressDaoMysqlTest {
    ...
    public void insert() {
        ...
        Express e = new Express("12311","帅哥l","18516955565","顺丰快递","18888888888","666666");
    ...
    public void insert2() {
        ...
        try {
            for(int i=0;i<100;i++){
                Express e = new Express("12311"+i,"帅哥l","18516955565","顺丰快递","18888888888",666000+i+"");
                insert = dao.insert(e);
            }
